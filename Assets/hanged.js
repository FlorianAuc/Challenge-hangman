...
const words = ['rythme', 'immersion', 'rondelle', 'visite', 'cabine', 'lettre', 'horloge', 'cannibale', 'bibliotheque', 'censure', 'diplomate', 'tailleur', 'frisson', 'inclinaison', 'personne', 'document', 'application', 'programmation','interface', 'javascript', 'iceberg', 'verdict', 'extracteur', 'ballon', 'casque', 'centre', 'prairie', 'peur', 'boulloire', 'photographie', 'reste', 'europe', 'belgique', 'france', 'allemagne','suisse', 'espagne', 'turquie','loin'];
...
function updateBadLetterEl(){
    ...
    //affiche son la personne a perdu
